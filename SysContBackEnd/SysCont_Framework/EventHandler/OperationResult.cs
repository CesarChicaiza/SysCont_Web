...
namespace SysCont_Framework.EventHandler
{
    public class OperationResult<TResult>
    {
        ...
        {
            return new OperationResult<TResult> { Success = false, NonSuccessMessage = "No fue posible obtener la información de la base de datos." };
        }
