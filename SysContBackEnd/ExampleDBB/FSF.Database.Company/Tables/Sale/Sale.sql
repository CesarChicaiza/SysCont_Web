...
(
	...
	CONSTRAINT [FK_Sales_BusinessOportunity] FOREIGN KEY ([BusinessOpportunity_Id]) REFERENCES [BusinessOpportunity]([Id]),
    CONSTRAINT [FK_Sale_Campaign] FOREIGN KEY ([Campaign_Id]) REFERENCES [Campaign]([Id]), 
